  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <input type="text" placeholder="Short Description" value={shortDesc} onChange={e=>setShortDesc(e.target.value)} className="border border-gray-300 px-3 py-2 rounded"/>
        <textarea placeholder="Description" value={desc} onChange={e=>setDesc(e.target.value)} className="border border-gray-300 px-3 py-2 rounded"/>
        
        <div>
          <h3 className="font-semibold mb-1">Images</h3>
          <input type="file" multiple onChange={e=>setImageFiles([...e.target.files])} className="border border-gray-300 p-1 rounded"/>
